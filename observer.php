 ...
 * PHP has several built-in interfaces (SplSubject, SplObserver) that can be used 
 * to make your implementations of the Observer pattern compatible with the rest of the PHP code.
 */
